...
```
The mean number of steps taken each day was: `r meanDaily`.  
The median number of steps taken each day was: `r medianDaily`.  
...
```
The mean number of steps taken each day with was: `r meanDailyFill`.  
The median number of steps taken each day was: `r medianDailyFill`.  
